...
export const pauseTimed     = (minutes: number) => sabGet({ mode: 'pause', value: minutes })
export const pauseAllJobs   = () => sabGet({ mode: 'queue', name: 'pause_all' })
export const resumeAllJobs  = () => sabGet({ mode: 'queue', name: 'resume_all' })
export const setPriorityAll = (value: number) => sabGet({ mode: 'queue', name: 'priority', nzo_ids: 'all', value })
export const retryAllFailed = () => sabGet({ mode: 'retry_all' })
export const getStats       = () => sabGet({ mode: 'get_stats' })
export const purgeQueue     = (del_files = 0) => sabGet({ mode: 'purge', del_files })
